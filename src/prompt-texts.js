...
export const PROMPT_TEXTS = [
    ...
    },
    {
        ...
        text: lines(
            ...
            '{{minimalReply}}',
            'Everyone present is listed; only changes and initial values for blank NPC fields carry a value.',
            '{{/minimalReply}}',
            '{{#earlier}}',
            '',
    ...
    },
    {
        ...
        text: lines('You are filling in a character sheet for one character in a roleplaying session.',
            ...
            '',
            '- Fill every field you are asked for. Infer a fitting value from the material;',
            '  when it is unclear, invent a plausible value for this character.',
